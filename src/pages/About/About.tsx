  ...
  return (
    <div className="layout-text">
      ...
      <ol>
        ...
        <li>
          After 10 correct marks, the word/phrase is marked as learned and is not shown in the list of learned
          phrases by default.
        </li>
      </ol>
      <p>
        ...
        <br />
        But in the settings you can specify data for accessing{' '}
